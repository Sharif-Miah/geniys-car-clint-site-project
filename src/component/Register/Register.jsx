...
const Register = () => {
    ...
    const { createUserInRegister } = useContext(AuthContext)
    ...
    const handleRegister = event => {
        ...
        createUserInRegister(email, password)
            .then(result => {
                    ...
                    <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
                        ...
                        <form onSubmit={handleRegister} novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                            <div className="space-y-1 text-sm">
                                ...
                                <input type="text" name="name" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:dark:border-violet-400" />
                            </div>
                            <div className="space-y-1 text-sm">
                            ...
                            <button className="block w-full p-3 text-center rounded-sm dark:text-gray-900 bg-red-500 text-white">Register</button>
                        </form>
