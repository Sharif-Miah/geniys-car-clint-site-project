...
const BannerItems = ({ banner }) => {
    ...
    return (
        <div id={`banner${id}`} className="carousel-item relative w-full">
            ...
            <div className="absolute flex justify-end transform left-24 top-1/3">
            ...
            <div className="absolute flex justify-end transform  w-2/5 left-24 top-1/2">
            ...
            <div className="absolute flex justify-start transform  w-2/5 left-24 top-3/4">
